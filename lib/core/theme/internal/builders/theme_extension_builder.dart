import '../../system/theme_extensions.dart';
import 'button_builder.dart';
import 'card_builder.dart';
import 'dialog_builder.dart';

class TibebThemeExtensionBuilder {
  const TibebThemeExtensionBuilder._();
  ...
  static TibebThemeExtension light() {
    ...
    return TibebThemeExtension(
      ...
      motion: const TibebMotionTokens(),
      opacity: const TibebOpacityTokens(),
      ...
      dialog: TibebDialogBuilder.light(colors, radius),
      card: TibebCardBuilder.light(colors, radius, elevation),
      listTile: TibebListTileThemeTokens.light(colors),
      buttons: TibebButtonBuilder.light(colors, radius),
  ...
  static TibebThemeExtension dark() {
    ...
    return TibebThemeExtension(
      ...
      dialog: TibebDialogBuilder.dark(colors, radius),
      card: TibebCardBuilder.dark(colors, radius, elevation),
      listTile: TibebListTileThemeTokens.dark(colors),
      buttons: TibebButtonBuilder.dark(colors, radius),
